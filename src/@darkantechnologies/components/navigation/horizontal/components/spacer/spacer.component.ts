...
@Component({
    selector       : 'darkantechnologies-horizontal-navigation-spacer-item',
    templateUrl    : './spacer.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DarkanTechnologiesHorizontalNavigationSpacerItemComponent implements OnInit, OnDestroy
{
