...
@Component({
    selector       : 'darkantechnologies-horizontal-navigation-basic-item',
    templateUrl    : './basic.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DarkanTechnologiesHorizontalNavigationBasicItemComponent implements OnInit, OnDestroy
{
