...
@Component({
    selector       : 'darkantechnologies-horizontal-navigation',
    templateUrl    : './horizontal.component.html',
    styleUrls      : ['./horizontal.component.scss'],
    animations     : darkantechnologiesAnimations,
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'darkantechnologiesHorizontalNavigation'
})
export class DarkanTechnologiesHorizontalNavigationComponent implements OnChanges, OnInit, OnDestroy
{
