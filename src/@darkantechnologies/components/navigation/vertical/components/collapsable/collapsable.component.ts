...
@Component({
    selector       : 'darkantechnologies-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : darkantechnologiesAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DarkanTechnologiesVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any
    {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'darkantechnologies-vertical-navigation-item-collapsed': this.isCollapsed,
            'darkantechnologies-vertical-navigation-item-expanded' : this.isExpanded
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void
    {
        ...
        this._darkantechnologiesVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._darkantechnologiesVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._darkantechnologiesVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._darkantechnologiesVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _hasActiveChild(item: DarkanTechnologiesNavigationItem, currentUrl: string): boolean
    {
     ...
     * @private
     */
    private _isChildrenOf(parent: DarkanTechnologiesNavigationItem, item: DarkanTechnologiesNavigationItem): boolean
    {
