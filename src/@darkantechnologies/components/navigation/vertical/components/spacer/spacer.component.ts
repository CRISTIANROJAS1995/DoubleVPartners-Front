...
@Component({
    selector       : 'darkantechnologies-vertical-navigation-spacer-item',
    templateUrl    : './spacer.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DarkanTechnologiesVerticalNavigationSpacerItemComponent implements OnInit, OnDestroy
{
