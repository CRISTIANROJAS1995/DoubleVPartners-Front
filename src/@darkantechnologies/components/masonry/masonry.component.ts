...
@Component({
    selector     : 'darkantechnologies-masonry',
    templateUrl  : './masonry.component.html',
    encapsulation: ViewEncapsulation.None,
    animations   : darkantechnologiesAnimations,
    exportAs     : 'darkantechnologiesMasonry'
})
export class DarkanTechnologiesMasonryComponent implements OnChanges, AfterViewInit
{
