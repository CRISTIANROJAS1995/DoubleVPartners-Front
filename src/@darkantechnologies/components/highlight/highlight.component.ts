...
import { DarkanTechnologiesHighlightService } from '@darkantechnologies/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[darkantechnologies-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'darkantechnologiesHighlight'
})
export class DarkanTechnologiesHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _darkantechnologiesHighlightService: DarkanTechnologiesHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._darkantechnologiesHighlightService.highlight(this.code, this.lang));
