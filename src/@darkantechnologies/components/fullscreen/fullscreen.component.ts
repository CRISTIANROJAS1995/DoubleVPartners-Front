...
import { FSDocument, FSDocumentElement } from '@darkantechnologies/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'darkantechnologies-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'darkantechnologiesFullscreen'
})
export class DarkanTechnologiesFullscreenComponent implements OnInit
{
