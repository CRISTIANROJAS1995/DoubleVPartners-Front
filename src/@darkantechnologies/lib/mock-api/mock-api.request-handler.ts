...
import { DarkanTechnologiesMockApiReplyCallback } from '@darkantechnologies/lib/mock-api/mock-api.types';

export class DarkanTechnologiesMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: DarkanTechnologiesMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: DarkanTechnologiesMockApiReplyCallback): void
    {
        // Store the reply
