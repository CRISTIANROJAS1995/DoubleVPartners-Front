...
import { DoublevPartnersMockApiReplyCallback } from '@doublevpartners/lib/mock-api/mock-api.types';

export class DoublevPartnersMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: DoublevPartnersMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: DoublevPartnersMockApiReplyCallback): void
    {
        // Store the reply
