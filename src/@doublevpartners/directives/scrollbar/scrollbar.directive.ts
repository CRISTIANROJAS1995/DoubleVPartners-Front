...
import { ScrollbarGeometry, ScrollbarPosition } from '@doublevpartners/directives/scrollbar/scrollbar.types';

/**
 * Wrapper directive for the Perfect Scrollbar: https://github.com/mdbootstrap/perfect-scrollbar
 */
@Directive({
    selector: '[doublevpartnersScrollbar]',
    exportAs: 'doublevpartnersScrollbar'
})
export class DoublevPartnersScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_doublevpartnersScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() doublevpartnersScrollbar: boolean = true;
    @Input() doublevpartnersScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'doublevpartnersScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.doublevpartnersScrollbar = coerceBooleanProperty(changes.doublevpartnersScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.doublevpartnersScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'doublevpartnersScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.doublevpartnersScrollbarOptions.currentValue);
    ...
    isEnabled(): boolean
    {
        return this.doublevpartnersScrollbar;
    }
    ...
    private _init(): void
    {
        ...
        {
            this.doublevpartnersScrollbar = false;
            return;
        }
