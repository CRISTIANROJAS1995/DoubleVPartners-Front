...
import { DoublevPartnersAnimationCurves, DoublevPartnersAnimationDurations } from '@doublevpartners/animations/defaults';
...
const slideInTop = trigger('slideInTop',
    [
        ...
        transition('void => *', animate('{{timings}}'),
            {
                params: {
                    timings: `${DoublevPartnersAnimationDurations.entering} ${DoublevPartnersAnimationCurves.deceleration}`
                }
            }
        )
    ]
...
const slideOutTop = trigger('slideOutTop',
    [
        ...
        transition('* => void', animate('{{timings}}'),
            {
                params: {
                    timings: `${DoublevPartnersAnimationDurations.exiting} ${DoublevPartnersAnimationCurves.acceleration}`
                }
            }
        )
    ]
