...
@Component({
    selector       : 'doublevpartners-horizontal-navigation-divider-item',
    templateUrl    : './divider.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DoublevPartnersHorizontalNavigationDividerItemComponent implements OnInit, OnDestroy
{
