...
@Component({
    selector       : 'doublevpartners-vertical-navigation-aside-item',
    templateUrl    : './aside.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DoublevPartnersVerticalNavigationAsideItemComponent implements OnChanges, OnInit, OnDestroy
{
