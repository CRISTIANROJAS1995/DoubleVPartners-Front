...
@Component({
    selector       : 'doublevpartners-vertical-navigation-divider-item',
    templateUrl    : './divider.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DoublevPartnersVerticalNavigationDividerItemComponent implements OnInit, OnDestroy
{
