...
@Component({
    selector       : 'doublevpartners-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : doublevpartnersAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DoublevPartnersVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any
    {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'doublevpartners-vertical-navigation-item-collapsed': this.isCollapsed,
            'doublevpartners-vertical-navigation-item-expanded' : this.isExpanded
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void
    {
        ...
        this._doublevpartnersVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._doublevpartnersVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._doublevpartnersVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._doublevpartnersVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _hasActiveChild(item: DoublevPartnersNavigationItem, currentUrl: string): boolean
    {
     ...
     * @private
     */
    private _isChildrenOf(parent: DoublevPartnersNavigationItem, item: DoublevPartnersNavigationItem): boolean
    {
