...
import { FSDocument, FSDocumentElement } from '@doublevpartners/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'doublevpartners-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'doublevpartnersFullscreen'
})
export class DoublevPartnersFullscreenComponent implements OnInit
{
