...
import { DoublevPartnersHighlightService } from '@doublevpartners/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[doublevpartners-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'doublevpartnersHighlight'
})
export class DoublevPartnersHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _doublevpartnersHighlightService: DoublevPartnersHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._doublevpartnersHighlightService.highlight(this.code, this.lang));
